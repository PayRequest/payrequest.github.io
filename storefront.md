          ...
          <div class="container">
            <div class="row align-items-center text-left">
              <div class="col-lg-6 col-12">
                <span class="badge badge-info badge-pill mb-3">Storefront Page</span>
<h1 class="display-3">PayRequest Storefront,
<span class="text-primary">Create your Storefront webshop.</span></h1>
                <p class="lead pb-4">PayRequest makes it easy to create own webshop <br />
                	Just add products, connect your Stripe account and start selling.
...
<h2 class="display-3 text-center">Donation Page Examples<span class="text-success">See what you could make.</span></h2>

<div class="row">
 <div class="card" style="width: 18rem;">
  <img class="card-img-top" src="https://payrequest.io/assets/img/screens/donation-pages.png" alt="Card image cap">
  <div class="card-body text-center">
    <h5 class="card-title">Education Donation Page</h5>
 ...
 <div class="card" style="width: 18rem;">
  <img class="card-img-top" src="https://payrequest.io/assets/img/screens/donation-pages.png" alt="Card image cap">
  <div class="card-body text-center">
    <h5 class="card-title">Animals Donation Page</h5>
    <a href="#" class="btn btn-primary">See example</a>
</div></div>
...
<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="https://payrequest.io/assets/img/screens/donation-pages.png" alt="Card image cap">
  <div class="card-body text-center">
    <h5 class="card-title">Nature Donation Page</h5>
    <a href="#" class="btn btn-primary">See example</a>
</div></div>

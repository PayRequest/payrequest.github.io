...
<div class="icon icon-shape bg-gradient-white shadow rounded-circle mb-3"><i class="fal fa-alarm-clock text-info" aria-hidden="true"></i></div>
                        
<h1 class="text-white">Send Payment Reminders
</h1>
                        <p class="lead text-white">Send friendly and custimized payment reminders to your customers and increase payment ratio.
</p>
          ...
          <div class="container">
            <div class="row align-items-center text-left">
              <div class="col-lg-6 col-12">
                <span class="badge badge-info badge-pill mb-3">start today</span>
<h1 class="display-3">Send Payment Reminders,<span class="text-primary">Until you get paid</span></h1>
                <p class="lead pb-4">Send your clients a reminder about invoices that still are not paid, and increase your income.
...
<a href="https://dashboard.payrequest.io" class="btn btn-lg btn-github btn-icon mb-3 mb-sm-0">
                                ...
                                <span class="btn-inner--text">Start sending payment reminders</span>
                            </a>
 ...
 <div class="col-lg-6 col-12 pl-0">
                <img class="ml-lg-5" src="https://payrequest.io/assets/img/about/undraw_reminders_697p.svg" width="100%">
              </div>
            </div>
          </div>
</section>
...
<h3 style="
    /* float: right; */
    margin-left: 90px;
">Start sending Payment reminders in 3 simple steps.</h3>
...
<div class="row">
          ...
          <div class="col-sm-4 aos-init aos-animate" data-aos="fade-up" data-aos-easing="delay-slide" data-aos-duration="1300" data-aos-delay="500" data-aos-offset="-100">
            <div class="img-wrap">
              <img src="https://i.imgur.com/bnRvxjs.png" alt="get widget code snippet screenshot">

...
<div class="icon icon-shape bg-gradient-white shadow rounded-circle mb-3"><i class="fa fa-hand-holding-heart text-info"></i></div>
						<h1 class="text-white">Stripe Donation Button
</h1>
						<p class="lead text-white">
						Create your own stripe <a class="text-white" href="donation-pages">donation button </a> and accept donations, our donation platform is perfect for international fundraising events.
						</p>
...
<h1 class="display-3">Donation Buttons,
...
<a href="https://dashboard.payrequest.io" class="btn btn-lg btn-github btn-icon mb-3 mb-sm-0">
                                ...
                                <span class="btn-inner--text">Create your doantion button</span>
                            </a>
  </p>
</div>
...
<h3 style="
    /* float: right; */
    margin-left: 90px;
">Start create your Donation Button in 3 simple steps.</h3>
...
<div class="three-steps row">
          ...
          <div class="col-sm-4 aos-init aos-animate" data-aos="fade-up" data-aos-easing="delay-slide" data-aos-duration="1300" data-aos-delay="500" data-aos-offset="-100">
            ...
            <h4>2. Create your donation button.</h4>
          </div>
...
">
          ...
          <div class="col-lg-6 mx-auto order-md-1">
            <div class="section-description">
              <h2 class="display-3">Donation Button Features<span class="text-success">Show your progress.</span></h2>
              <p class="lead">PayRequest not only makes it easy to create a donation button, you can also setup your donation goal, follow the progress via a realtime bar and see the latests donation via the donations feed.
</p>
            </div>
          </div>
        </div>
...
<section class="section-free-demo bg-secondary" style="padding: 40px 0;">
      <div class="container">
        <div class="row">
          <div class="col-lg-7 col-md-12">
            <div class="section-description">
              <h3 class="display-3">Start your donation button</h3>
              ...
              <span class="nav-link-inner--text"> Create your donation button </span>
            </a>
            </div>
          </div>

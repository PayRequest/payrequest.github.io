          ...
          <div class="container">
            <div class="row align-items-center text-left">
              <div class="col-lg-6 col-12">
                <span class="badge badge-info badge-pill mb-3">Share your page</span>
<h1 class="display-3">Payment Button,<span class="text-primary"> Share your payment page</span></h1>
                <p class="lead pb-4">Payment buttons allow you to redirect your visitors to your payment page.

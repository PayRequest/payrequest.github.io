               ...
               <div class="col-lg-12">
                  <div class="breadcrumb-inn">
                     <div class="section-title wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.3s; animation-name: fadeInUp;">
                       <h2>Stripe One Time <span>Payment</span></h2>
                     </div>
                  </div>
               </div>
            </div>
...
">
               ...
               <div class="col-lg-6">
                  <div class="about-page-text wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.6s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.6s; animation-name: fadeInRight;">
                     <div class="section-title wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.3s; animation-name: fadeInUp;">
                     <h2>Generate Stripe one time
<span>payments</span>

</h2>
                  </div>

<h3>PayRequest makes it easy use our generate stripe one time payment links and send them worldwide with all your customers, accept credit card payments online.

<br><br>

We connect your Stripe account to easily generate stripe one time payment links via the PayRequest Dashboard, no coding required and accept all leading payment methods.
...
<h2>Start generate<span> Stripe One Time Payment</span><br> in 3 simple steps.</h2>
</div>
                  </div>
...
">
    ...
    color: #1c2045;
    margin-left: 20px;
">2. Generate a stripe one time payment.</h5>
          </div>

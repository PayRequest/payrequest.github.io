---
title: Send Stripe Payment Request
description: We connect your Stripe account to easily send stripe payment request.
---
...
<div class="icon icon-shape bg-gradient-white shadow rounded-circle mb-3"><i class="fal fa-link text-info" aria-hidden="true"></i></div>
  ...
  <h1 class="text-white">Send Stripe Payment Request
</h1>
                        <p class="lead text-white">We connect your Stripe account to easily send stripe payment request via your own paynet page, no coding required and all leading payment methods.
</p>
          ...
          <div class="container">
            <div class="row align-items-center text-left">
              <div class="col-lg-6 col-12">
                <span class="badge badge-info badge-pill mb-3">Send Stripe Request</span>
<h1 class="display-3">Stripe Payment Request,<span class="text-primary">Send payment request</span></h1>
                <p class="lead pb-4">PayRequest makes it easy to create stripe payment request and send them worldwide with all your customers,
...
<a href="https://dashboard.payrequest.io" class="btn btn-lg btn-github btn-icon mb-3 mb-sm-0">
                                ...
                                <span class="btn-inner--text">Send Stripe payment request</span>
                            </a>
...
<h3 style="
    /* float: right; */
    margin-left: 90px;
">Start sending Stripe Payment Request in 3 simple steps.</h3>
...
<div class="row">
          ...
          <div class="col-sm-4 aos-init aos-animate" data-aos="fade-up" data-aos-easing="delay-slide" data-aos-duration="1300" data-aos-delay="500" data-aos-offset="-100">
            ...
            <h4>2. Create your own payment request.</h4>
          </div>
          <div class="col-sm-4 aos-init aos-animate" data-aos="fade-up" data-aos-easing="delay-slide" data-aos-duration="1300" data-aos-delay="600" data-aos-offset="-100">
            ...
            <h4>3. Share stripe payment request and get paid!</h4>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 mx-auto order-md-1">
            <div class="section-description">
              <h2 class="display-3">PayRequest Dashboard<span class="text-success">Manage your stripe payment requests.</span></h2>
              <p class="lead">The PayRequest Dashboard lets you manage all your stripe payment request, with a simple overview you can view all status and reminders that are send, you will also get a log update when someone views, chooses payment type or pays your payment request.

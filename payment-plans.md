 ...
 <div class="container">
            <div class="row align-items-center">
             <div class="col-lg-6 col-md-6">
                  <div class="hero-left">
<h2>Save time with <span class="underline">Payment Plans</span></h2>

<h3> With payment plans you can create one-time or subscription plans, This will save you time when you create new payment links.</h3>
...
<img alt="Stripe logo" src="https://payrequest.io/assets/img/stripe-partner-badges/L_Color_Solid.svg" style="height: 63px;padding: 6px;">
 ...
 <div class="col-lg-6 col-md-6">
                  <div class="hero-right">
                   <img src="https://i.imgur.com/0aTv9l5.png" alt="payment plans" style="
...
<div class="about-right wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.3s; animation-name: fadeInRight;">
  <img src="https://i.imgur.com/mz4vxyM.png" alt="payrequest dashboard">
                     </div>
</div>
    </div>
 </div>

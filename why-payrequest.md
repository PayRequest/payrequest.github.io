...
">
    ...
    We are your payment stack

<div class='a'>Payment API</div>
<div class='b'>Payment Gateways</div>
<div class='c'>Payment Widgets</div>
<div class='d'>Payment Links</div>
<div class='e'>Stripe</div>
<div class='f'>Donations</div>
<div class='g'>Payment Reminders</div>
<div class='h'>Send Invoies</div>

<style>
  body {
   background: linear-gradient(130deg, #1951bf 0%, #25b7c7 89%) !important; 
    color: white;

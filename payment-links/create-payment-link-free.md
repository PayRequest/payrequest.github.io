...
<a href="https://dashboard.payrequest.io" class="btn btn-lg btn-github btn-icon mb-3 mb-sm-0">
                                ...
                                <span class="btn-inner--text">Send payment links</span>
                            </a>
...
<h3 style="
    /* float: right; */
    margin-left: 90px;
">Start sending Free Payment Links in 3 simple steps.</h3>
...
<div class="row">
          ...
          <div class="col-sm-4 aos-init aos-animate" data-aos="fade-up" data-aos-easing="delay-slide" data-aos-duration="1300" data-aos-delay="600" data-aos-offset="-100">
            ...
            <h4>3. Share payment link and get paid!</h4>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-7 col-md-12">
            <div class="section-description">
              <h3 class="display-3">Payment Links with Stripe</h3>
...
<a href="https://dashboard.payrequest.io" class="btn btn-lg btn-github btn-icon mb-3 mb-sm-0">
                                <span class="btn-inner--icon"><i class="fal fa-link" aria-hidden="true"></i></span>
                                <span class="btn-inner--text">Send free payment links</span>
                            </a>
   </div>
          </div>

...
description: Send payments via email directly in our dashboard
---
...
<div class="icon icon-shape bg-gradient-white shadow rounded-circle mb-3"><i class="fal fa-browser text-info" aria-hidden="true"></i></div>
                        
  <h1 class="text-white">Hosted Payment Page
</h1>
 <p class="lead text-white">Send payments via email directly in our dashboard, also you can send email reminders and use email tracking to know when someone opens your payment link.
</p>
...
<h1 class="display-3">Hosted Payment Page,<span class="text-primary">we send it for you.</span></h1>
...
<a href="https://dashboard.payrequest.io" class="btn btn-lg btn-github btn-icon mb-3 mb-sm-0">
                                ...
                                <span class="btn-inner--text">Start accept email payments</span>
                            </a>
...
<h3 style="
    /* float: right; */
    margin-left: 90px;
">Accept Hosted Payment Page in 3 simple steps.</h3>
...
<div class="row">
          ...
          <div class="col-sm-4 aos-init aos-animate" data-aos="fade-up" data-aos-easing="delay-slide" data-aos-duration="1300" data-aos-delay="600" data-aos-offset="-100">
            ...
            <h4>3. Send email payment links and get paid!</h4>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-7 col-md-12">
            <div class="section-description">
              <h3 class="display-3">Create Hosted  Stripe Payment Page</h3>
...
<a href="https://dashboard.payrequest.io" class="btn btn-lg btn-github btn-icon mb-3 mb-sm-0">
                                <span class="btn-inner--icon"><i class="fal fa-link" aria-hidden="true"></i></span>
                                <span class="btn-inner--text">Start a hosted payment page</span>
                            </a>
   </div>
          </div>

...
<div class="icon icon-shape bg-gradient-white shadow rounded-circle mb-3"><i class="fal fa-link text-info" aria-hidden="true"></i></div>
  ...
  <h1 class="text-white">Accept Email Payments
</h1>
...
<h1 class="display-3">Accept Email Payments,<span class="text-primary">we send it for you.</span></h1>
...
<h3 style="
    /* float: right; */
    margin-left: 90px;
">Accept Emails Payments in 3 simple steps.</h3>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-7 col-md-12">
            <div class="section-description">
              <h3 class="display-3">Accept Stripe email payments</h3>
...
<a href="https://dashboard.payrequest.io" class="btn btn-lg btn-github btn-icon mb-3 mb-sm-0">
                                <span class="btn-inner--icon"><i class="fal fa-link" aria-hidden="true"></i></span>
                                <span class="btn-inner--text">Start accepting email payments</span>
                            </a>
   </div>
          </div>

...
<div class="icon icon-shape bg-gradient-white shadow rounded-circle mb-3"><i class="fal fa-link text-info" aria-hidden="true"></i></div>
            <h1 class="text-white">Hosted Checkout Page
</h1>
            <p class="lead text-white">Create and share your hosted checkout page, no coding required.
<br />
<br />
          ...
          <div class="container">
            <div class="row align-items-center text-left">
              <div class="col-lg-6 col-12">
                <span class="badge badge-info badge-pill mb-3">Hosted checkout page</span>
<h1 class="display-3">Hosted Checkout Page,<span class="text-primary">Accept payments worldwide.</span></h1>
                <p class="lead pb-4">PayRequest makes it easy to create hosted checkout pages and share them worldwide with all your customers,
...
<a href="https://dashboard.payrequest.io" class="btn btn-lg btn-github btn-icon mb-3 mb-sm-0">
                                ...
                                <span class="btn-inner--text">Create your hosted checkout page</span>
                            </a>
...
<h3 style="
    /* float: right; */
    margin-left: 90px;
">Start created Hosted Checkout Pages in 3 simple steps.</h3>
...
<div class="row">
          ...
          <div class="col-sm-4 aos-init aos-animate" data-aos="fade-up" data-aos-easing="delay-slide" data-aos-duration="1300" data-aos-delay="500" data-aos-offset="-100">
            ...
            <h4>2. Create your own hosted checkout page.</h4>
          </div>
          <div class="col-sm-4 aos-init aos-animate" data-aos="fade-up" data-aos-easing="delay-slide" data-aos-duration="1300" data-aos-delay="600" data-aos-offset="-100">
            ...
            <h4>3. Share your hosted checkout page and get paid!</h4>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-7 col-md-12">
            <div class="section-description">
              <h3 class="display-3"> Start creating hosted checkout pages</h3>
              <p class="lead mb-4">Create a hosted checkout page for your customer or use reusaable links to let all your customers pay.</p>
              ...
              <span class="nav-link-inner--text"> Create your hosted checkout page</span>
            </a>
            </div>
          </div>
